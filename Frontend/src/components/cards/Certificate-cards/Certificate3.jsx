...
import Courseimg1 from "../../../assets/certificates/itc.png";
        ...
        <div className="content">
          <div className="back">
            <div className="back-content">
              ...
              <strong className='text-center'>Introduction to Computers</strong>
            </div>
          </div>
          <div className="front">
            <div className="img">
            ...
            <div className="front-content">
              <small className="badge">ITC</small>
              <div className="description">
                ...
                <a href="https://www.coursera.org/account/accomplishments/verify/G89RLA8W5GE5">
