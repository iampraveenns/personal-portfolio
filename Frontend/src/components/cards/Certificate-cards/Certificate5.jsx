...
import Courseimg1 from "../../../assets/certificates/designThinking.png";
        ...
        <div className="content">
          <div className="back">
            <div className="back-content">
              ...
              <strong className='text-center'>Design Thinking for Innovation</strong>
            </div>
          </div>
          <div className="front">
            <div className="img">
            ...
            <div className="front-content">
              <small className="badge">DTI</small>
              <div className="description">
                <div className="title">
                  <p className="title">
                    <strong>Design Thinking for Innovation</strong>
                  </p>
                ...
                <a href="https://www.coursera.org/account/accomplishments/verify/ER82SDA17B3J">
