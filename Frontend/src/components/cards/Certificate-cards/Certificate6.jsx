        ...
        <div className="content">
          <div className="back">
            <div className="back-content">
              ...
              <strong className='text-center'>C for Everyone</strong>
            </div>
          </div>
          <div className="front">
            <div className="img">
            ...
            <div className="front-content">
              <small className="badge">C Programme</small>
              <div className="description">
                <div className="title">
                  <p className="title">
                    <strong>C for Everyone</strong>
                  </p>
                ...
                <a href="https://www.coursera.org/account/accomplishments/verify/G1II9XYH1ATS">
