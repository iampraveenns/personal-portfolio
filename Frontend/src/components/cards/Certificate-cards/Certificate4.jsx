        ...
        <div className="content">
          <div className="back">
            <div className="back-content">
              ...
              <strong className='text-center'>Computer Hardware and Software</strong>
            </div>
          </div>
          <div className="front">
            <div className="img">
            ...
            <div className="front-content">
              <small className="badge">H/W & S/W</small>
              <div className="description">
                <div className="title">
                  <p className="title">
                    <strong>Computer Hardware and Software</strong>
                  </p>
                ...
                <a href="https://www.coursera.org/account/accomplishments/verify/3TFP125FDD7R">
