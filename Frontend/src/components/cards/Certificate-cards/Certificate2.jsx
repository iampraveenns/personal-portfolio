...
import Courseimg2 from "../../../assets/certificates/promptEng.png";
        ...
        <div className="content">
          <div className="back">
            <div className="back-content">
              ...
              <strong className='text-center'>Generative AI : Prompt Engineering Basics</strong>
            </div>
          </div>
          <div className="front">
            <div className="img">
                <img src={Courseimg2} className='rotate-90 object-fit mx-auto h-full w-full' alt="CN-Certificate" />
            ...
            <div className="front-content">
              <small className="badge">Gen AI - prompt</small>
              <div className="description">
                <div className="title">
                  <p className="title">
                    <strong>Generative AI: Prompt Engineering Basics</strong>
                  </p>
                ...
                <a href="https://www.coursera.org/account/accomplishments/verify/BVK0DZ8GFSO4">
