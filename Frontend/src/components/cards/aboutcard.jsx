                ...
                <div className="canvas">
                    ...
                    <div id="card">
                        <div className="card-content">
                            ...
                            <img src={profile} alt="praveenImg" className='w-full h-full object-cover rounded-[5px] overflow-hidden scale-x-[1.15] scale-y-[1.11]'
                            style={{ filter: 'contrast(1.2' }}
                            />
                            <div className="title">Praveen</div>
