    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://www.linkedin.com/in/iampraveenns/" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://github.com/iampraveenns" aria-label="GitHub" data-social="github">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a href="https://leetcode.com/u/TUvnIm9UYY/" aria-label="Leetcode" data-social="Leetcode">
            <div className="filled" />
            <SiLeetcode size={32} color='white' />
          </a>
          <div className="tooltip">Leetcode</div>
        </li>
        <li className="icon-content">
          <a href="mailto:praveenselvaraj2004@gmail.com" aria-label="Email" data-social="Email">
            <div className="filled" />
            <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="bi bi-Email" viewBox="0 0 16 16" xmlSpace="preserve">
